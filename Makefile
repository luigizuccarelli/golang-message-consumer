...
container:
	podman build -t quay.io/luigizuccarelli/golang-message-consumer:1.16.3 .

push:
	podman push --authfile=/home/lzuccarelli/config.json  quay.io/luigizuccarelli/golang-message-consumer:1.16.3 
